<template>
  ...
  export default {
    data() {
      return {
        events: [
          { EventId: "1", UserId: "123", Title: "Dog Walking", Description: "Walk the dog in the park", EventDate: "2024-10-12", Location: "Central Park" },
  ...
  .clickable-date:hover {
    cursor: pointer;
    background-color: rgba(34, 101, 255, 0.505); /* Highlight color on hover */
