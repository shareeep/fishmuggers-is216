  ...
  data() {
    return {
      events: [
        ...
        { EventId: "2", UserId: "124", Title: "Pet Adoption Fairs", Description: "Adoption event for pets", EventDate: "2024-10-20", Location: "City Hall", PetType: "Cat", EventSize: "50-100" },
