...
async function fetchReceivedRequests() {
  try {
    const response = await api.get(`https://fishmuggers-is216-express.onrender.com/api/friends/requests/${userId}`);
...
async function handleAcceptRequest(requestId) {
  ...
  try {
    ...
    await api.put(`https://fishmuggers-is216-express.onrender.com/api/friends/request/accept/${requestId}`);
...
async function handleRejectRequest(requestId) {
  ...
  try {
    await api.put(`https://fishmuggers-is216-express.onrender.com/api/friends/request/reject/${requestId}`);
    receivedRequests.value = receivedRequests.value.filter(request => request.id !== requestId);
...
async function fetchMyFriends() {
  try {
    const response = await api.get(`https://fishmuggers-is216-express.onrender.com/api/friends/${userId}`);
...
async function fetchUsers() {
  try {
    const response = await api.get('https://fishmuggers-is216-express.onrender.com/api/users');
...
async function fetchSentRequests() {
  try {
    const response = await api.get(`https://fishmuggers-is216-express.onrender.com/api/express.onrender.com/api/express.onrender.com/api/express.onrender.com/api/express.onrender.com/api/express.onrender.com/api/express.onrender.com/api/express.onrender.com/api/friends/requests/sent/${userId}`);
